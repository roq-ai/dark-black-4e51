...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin', 'content-moderator', 'super-admin'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Post', path: '/posts', entity: 'post', service: AccessServiceEnum.PROJECT, icon: FiMessageCircle },
    { name: 'Topic', path: '/topics', entity: 'topic', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
